...
from cvdm.models.mean_model import mean_model
from cvdm.models.noise_model import noise_model
from cvdm.models.variance_model import variance_model
...
def create_joint_model(
    ...
    #delta_noise = tf.square(pred_noise_Lt - n_sample_Lt[1]) * tf.abs(dirty_img)
    L_beta = (
